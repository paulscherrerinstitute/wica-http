...
/*- Private attributes -------------------------------------------------------*/
   ...
   private Map<WicaChannel, WicaChannelMetadata>        metadataMap = Map.of( WicaChannel.createFromName( "chan1"), WicaChannelMetadata.createUnknownInstance() );
   private Map<WicaChannel, List<WicaChannelValue>> initialValueMap = Map.of( WicaChannel.createFromName( "chan1"), List.of(WicaChannelValue.createChannelValueDisconnected() ) );
   private Map<WicaChannel, List<WicaChannelValue>> polledValueMap  = Map.of( WicaChannel.createFromName( "chan1"), List.of( WicaChannelValue.createChannelValueDisconnected() ) );
   private Map<WicaChannel, List<WicaChannelValue>> changedValueMap = Map.of( WicaChannel.createFromName( "chan1"), List.of(WicaChannelValue.createChannelValueDisconnected() ) );
...
/*- Public methods -----------------------------------------------------------*/
   ...
   void beforeEach()
   {
      ...
      given( wicaStreamDataCollectorServiceMock.getPolledValues( captor.capture()  ) ).willReturn( polledValueMap );
      given( wicaStreamDataCollectorServiceMock.getNotifiedValueChanges( captor.capture()  ) ).willReturn( changedValueMap );
      given( wicaStreamDataCollectorServiceMock.getNotifiedValues( captor.capture()  ) ).willReturn( initialValueMap );
   }
   ...
   void testShutdown() throws InterruptedException
   {
      ...
      final var objectUnderTest = new WicaStreamServerSentEventPublisher(stream, wicaStreamDataCollectorServiceMock);
      ...
      assertThrows( IllegalStateException.class, objectUnderTest::getFlux );
   }
  ...
  //    final WicaStreamDataCollectorService supplier = new WicaStreamDataCollectorService(wicaChannelMetadataBufferingService, wicaChannelValueBufferingService);

      final var publisher = new WicaStreamServerSentEventPublisher(stream, wicaStreamDataCollectorServiceMock );
