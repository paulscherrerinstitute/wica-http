/*- Package Declaration ------------------------------------------------------*/
package ch.psi.wica.integration;
...
/*- Public methods -----------------------------------------------------------*/
   ...
   private static Stream<Arguments> getArgsTestCreateAndDeleteSingleThreadedThroughput()
   {
   ...
   @MethodSource( "getArgsTestCreateAndDeleteSingleThreadedThroughput" )
   @ParameterizedTest
   void testCreateAndDeleteSingleThreadedThroughput( int iterations, String jsonStreamConfig )
   {
   ...
   private static Stream<Arguments> getArgsTestCreateAndDeleteMultiThreadedThroughput()
   {
      return Stream.of( Arguments.of(   1, lightConsumerConfig   ),
                        Arguments.of(   2, lightConsumerConfig   ),
                        Arguments.of(   5, lightConsumerConfig   ),
   ...
   @MethodSource( "getArgsTestCreateAndDeleteMultiThreadedThroughput" )
   @ParameterizedTest
   void testCreateAndDeleteMultiThreadedThroughput( int iterations, String jsonStreamConfig ) throws InterruptedException, ExecutionException
   {
  ...
  // @CsvSource( { "1", "2", "5", "10", "20", "50", "100" } )
   @CsvSource( { "30, 60000" } )
   @ParameterizedTest
   void testGetSingleThreadedThroughput( int iterations, int sleepTimeInMillis, String jsonStreamConfig ) throws InterruptedException
   {
      logger.info( "Starting Single-Threaded Stream Create test..." );
      final StopWatch stopWatch = StopWatch.createStarted();
      final String firstResult = createStream( jsonStreamConfig );
      ...
      logger.info( "Stream Get Test completed {} iterations in {} ms. Throughput = {} requests/second. ", iterations, getStreamCycleTime, (1000 * iterations ) / getStreamCycleTime );
