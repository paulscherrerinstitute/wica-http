...
/*- Package-access methods ---------------------------------------------------*/
   ...
   void beforeEach()
   {
      ...
      assertThat( epicsChannelMonitorService.getStatistics().getStartRequests(), is( "0") );
      ...
      assertThat( epicsChannelMonitorService.getStatistics().getChannelConnectCount(), is( "0") );
      assertThat( epicsChannelMonitorService.getStatistics().getMonitorUpdateCount(), is( "0") );
   }
   ...
   {
      assertThrows( NullPointerException.class, () -> epicsChannelMonitorService.startMonitoring(null ) );
   }

   @Test
   void testStartMonitoring_ThrowsIllegalStateExceptionWhenChannelNameNotUnique()
   {
      epicsChannelMonitorService.startMonitoring( createMonitorRequest( "abcd" ));
      final var ex = assertThrows( IllegalStateException.class, () -> epicsChannelMonitorService.startMonitoring( createMonitorRequest( "abcd" ) ) );
   ...
   void testStartMonitoring_OneHundredChannelsConnectTime() throws InterruptedException
   {
      ...
      {
         epicsChannelMonitorService.startMonitoring( createMonitorRequest( channel ));
      }

      Thread.sleep( 500 );
      assertThat( epicsChannelMonitorService.getStatistics().getActiveRequests(), is( "100" ) );
   }
   ...
   void testStartMonitoring_CheckChannelStatisticsAsExpectedWhenDealingWithOfflineChannels()
   {
      ...
      epicsChannelMonitorService.startMonitoring( createMonitorRequest( "offline-channel-1" ) );
   }

   @Test
   void testStopMonitoring_ThrowsIllegalStateExceptionWhenStoppingMonitoringChannelThatWasNeverPreviouslyMonitored()
   {
      final var ex = assertThrows( IllegalStateException.class, () -> epicsChannelMonitorService.stopMonitoring( createMonitorRequest( "unknown-channel" ) ) );
   ...
   {
      epicsChannelMonitorService.startMonitoring( createMonitorRequest( "offline-channel-1" ) );
      assertThat( epicsChannelMonitorService.getStatistics().getActiveRequests(), is( "1" ) );

      epicsChannelMonitorService.stopMonitoring( createMonitorRequest( "offline-channel-1" ) );
      assertThat( epicsChannelMonitorService.getStatistics().getActiveRequests(), is( "0" ) );
   }
   ...
   void testStartMonitoring_CheckStatisticsAsExpectedWhenDealingWithOfflineChannels()
   {
      ...
      epicsChannelMonitorService.startMonitoring( createMonitorRequest( "non-existent-channel-1" ) );
      assertThat( epicsChannelMonitorService.getStatistics().getActiveRequests(), is( "1" ) );
      assertThat( epicsChannelMonitorService.getStatistics().getChannelConnectCount(), is( "0" ) );

      epicsChannelMonitorService.startMonitoring( createMonitorRequest( "non-existent-channel-2" ) );
   ...
   @Disabled
   @Test
   void testGetMonitorConnectCount() throws InterruptedException
   {
      epicsChannelMonitorService.startMonitoring( createMonitorRequest( "wica:test:db_ok" ) );
      assertThat( epicsChannelMonitorService.getStatistics().getStartRequests(), is( "1" ) );
      assertThat( epicsChannelMonitorService.getStatistics().getActiveRequests(), is( "1" ) );
      Thread.sleep( 1_000 );
      assertThat( epicsChannelMonitorService.getStatistics().getChannelConnectCount(), is( "1" ) );
   ...
   {
      assertThat( epicsChannelMonitorService.getStatistics().getActiveRequests(), is( "0" ) );
      epicsChannelMonitorService.startMonitoring( createMonitorRequest( "non-existent-channel" ) );
      Thread.sleep( 1_000 );
...
/*- Private methods ----------------------------------------------------------*/
   ...
   private EpicsChannelMonitorRequest createMonitorRequest( String name )
   {
      final WicaChannelName wicaChannelName = WicaChannelName.of( name );
      final WicaChannelProperties wicaChannelProperties = new WicaChannelProperties();
      final WicaChannel wicaChannel = new WicaChannel( wicaChannelName, wicaChannelProperties );
      return new EpicsChannelMonitorRequest( wicaChannel );
   }
