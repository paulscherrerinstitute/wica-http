...
@Service
@ThreadSafe
public class WicaChannelValueBufferingService
{
...
/*- Constructor --------------------------------------------------------------*/
   ...
   public WicaChannelValueBufferingService( @Value( "16" ) int bufferSize  )
   {
      final Logger logger = LoggerFactory.getLogger(WicaChannelValueBufferingService.class);
...
/*- Public methods -----------------------------------------------------------*/
   ...
   /**
    * Buffers incoming value update events.
    *
    * @param wicaChannelValueUpdateEvent the event.
    */
   @EventListener
   public void handleValueUpdate( WicaChannelValueUpdateEvent wicaChannelValueUpdateEvent )
   {
      final var controlSystemName = Validate.notNull( wicaChannelValueUpdateEvent.getControlSystemName() );
      final var wicaChannelValue = Validate.notNull( wicaChannelValueUpdateEvent.getWicaChannelValue() );

      add( controlSystemName, wicaChannelValue );
   }
    ...
    *         in this stream.
    */
   public synchronized Map<WicaChannel, List<WicaChannelValue>> getLaterThan( Set<WicaChannel> wicaChannels, LocalDateTime since )
   {
...
/*- Nested Classes -----------------------------------------------------------*/
    ...
    */
   private synchronized void add( ControlSystemName controlSystemName, WicaChannelValue wicaChannelValue )
   {
      Validate.notNull( controlSystemName );
