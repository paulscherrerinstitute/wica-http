...
/*- Public methods -----------------------------------------------------------*/
   ...
   public WicaStreamBuilder withChannelNameAndStreamProperties( String wicaChannelName )
   {
      ...
      Validate.isTrue(  ! wicaChannels.contains( wicaChannel ),"The 'WicaChannelName' argument specified a channel ('" + wicaChannelName + "') that was identical to one that was already defined." );
      wicaChannels.add ( wicaChannel );
      return this;
   }
